  ...
  if (!post) {
    return (
      <div className="surface-card p-6 md:p-7">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-cobalt-700">Blog</p>
        <h1 className="mt-2 font-display text-3xl font-bold text-ink">Story not found</h1>
        <p className="mt-2 text-sm text-sand-700">This article is not available. Browse all blog stories instead.</p>
        <Link
          to="/editorial"
      ...
      <section className="grid gap-5 lg:grid-cols-[1.05fr,0.95fr]">
        ...
        <aside className="space-y-4">
          <div className="surface-card-vivid p-5 md:p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-cobalt-700">Blog context</p>
            <h2 className="mt-1 font-display text-xl font-bold text-ink">Why this story matters</h2>
            <p className="mt-2 text-sm text-sand-700">
              Blog Spotlight tracks practical shifts in the creative economy so creators can act early with better strategy.
            </p>
